...
- `npx storybook@latest automigrate --config-dir libs/client/feature-login/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir libs/client/feature-register/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir libs/client/ui-components/.storybook --renderer @storybook/angular`
